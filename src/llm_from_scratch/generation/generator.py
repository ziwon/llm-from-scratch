...
from .sampling import top_k_sampling, top_p_sampling, apply_repetition_penalty
...
def generate(
    ...
    for _ in range(max_new_tokens):
        ...
        if eos_token_id is not None:
            unfinished_sequences = unfinished_sequences * (next_tokens != eos_token_id).long().squeeze()
